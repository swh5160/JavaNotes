...
![image-20230322102535530](assets/image-20230322102535530.png)
...
案例2：统计每种姓氏的人数
  提示：姓氏，就是去名字的第一个字符，可以使用Left函数
案例3：查询入职时间在 '2015-01-01' (包含) 以前的员工 , 并对结果根据职位分组 , 获取员工数量大于等于2的职位
  提示：
       入职时间是统计之前的条件
       员工数量是统计之后的条件
```
...
<img src="assets/image-20230227152541857.png" alt="image-20230227152541857" style="zoom:100%;" />
...
```
案例1：根据入职时间, 对员工进行升序排序案例2：统计每种姓氏的人数
...
![image-20230322163304459](assets/image-20230322163304459.png)
...
![image-20230322183141028](assets/image-20230322183141028.png)
